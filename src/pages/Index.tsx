...
export default function Index() {
  ...
  if (step === 'setup') {
    return (
      <div className="min-h-screen bg-base-100 flex flex-col" data-theme="orbit">
        <header className="flex items-center justify-between px-4 py-3 border-b border-base-300 shrink-0">
          <button
            ...
            className="p-2 -ml-2 hover:bg-base-200 rounded-lg text-base-content"
          >
            <X className="h-5 w-5" />
          </button>
          <span className="font-medium text-base-content">Quick Setup</span>
          <div className="w-9" />
        </header>
        ...
        <div className="flex-1 p-6 space-y-6">
          <div className="text-center space-y-2">
            ...
            <h2 className="text-xl font-semibold text-base-content">Tell me about your course</h2>
            <p className="text-base-content/60 text-sm">This helps me give you relevant feedback</p>
          </div>
          
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-base-content">Exam Board</label>
              <Select value={examBoard} onValueChange={setExamBoard}>
                <SelectTrigger className="h-12 bg-base-200 border-base-300 text-base-content">
                  <SelectValue placeholder="Select exam board" />
                </SelectTrigger>
                <SelectContent className="bg-base-200 border-base-300">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-base-content">Year Group</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-base-content">Target Grade</label>
            ...
            {['10', '11'].includes(yearGroup) && (
              <div className="space-y-2">
                <label className="text-sm font-medium text-base-content">Tier</label>
        ...
        <div className="p-6 shrink-0">
          <Button
            ...
            className="w-full h-12 bg-primary text-primary-content hover:bg-primary/90"
          >
            Continue
